...
# def step(sp_simulator, schedule_queue):
#     if schedule_queue:
...
#         # ++
#         total_waiting_time += current_time - event['subtime']
...
#         waiting_queue_time = 0
    
#     if last_train_time != current_time:
#         last_train_time = current_time
#         heapq.heappush(schedule_queue, (current_time, MyDict({'type': 'train'})))
