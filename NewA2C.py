...
class A2CAgent:
    def __init__(self, state_size=4, action_size=1, discount_factor=0.99, lr=1e-4):
...
class Trainer:
    def __init__(self, agent, generator, alpha=0.1, beta=0.01, num_episodes=100):
        self.agent = agent
    ...
    def train(self):
        ...
        for episode in range(self.num_episodes):
            ...
            print(f"jobs_queue: {len(jobs_queue)}")
...
def run_grid_search():
    ...
    trainer = Trainer(agent, generator, alpha=1, beta=1, num_episodes=50)
